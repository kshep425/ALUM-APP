...
const Scholarships = () => {
  return (
    <div className="container">
      <h1>Howard County Chapter Bear Pride Scholarship Application</h1>
      <br />
      ...
      <p>To qualify for this scholarship, the applicant must: </p>
        <ul>
          <li>Be a Howard County High School graduating senior or a student transferring to Morgan from Howard Community College.</li>
        ...
        <br />
        <p>Consideration will be given to candidates submitting complete application packages. To apply follow these steps: </p>
        <br />
        <ul>
        ...
        <br />
        <p>A complete application package must be postmarked no later than April 1st of the application year.</p>
        <br />
        <div>
          <h4>Mail to:</h4>
          <address>
          ...
          <br />
          <p>Click <a target="_blank" href="https://docs.google.com/forms/d/16OfOpbXHg8fElSNSJjTbvtlKqvo_U46-5M6p5CZLWyA/viewform?edit_requested=true">Here for an online form</a> or print from <a target="_blank" href="https://docs.google.com/document/d/1j4AwqFuagIXkuLFhCWT1dBYnbpBRkTKl86Unvkm6iP4/edit?usp=sharing" >HERE</a>.
        </p>
        </div>
    </div>
  );
