        ...
        (
          <div className="container">
            ...
            <div className="form-group">
              ...
              <input id="prefix" type="text" className="form-control" defaultValue={get(authUser, 'db.prefix')} ref={props.prefixRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="firstName">First Name</label>
              <input id="firstName" type="text" className="form-control" defaultValue={get(authUser, "db.firstName")} ref={props.firstNameRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="lastName">Last Name</label>
              <input id="lastName" type="text" className="form-control" defaultValue={get(authUser, "db.lastName")} ref={props.lastNameRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="suffix">Suffix</label>
              <input id="suffix" type="text" className="form-control" defaultValue={get(authUser, "db.suffix")} ref={props.suffixRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="email">Email</label>
              <input id="email" type="email" autoComplete="username" className="form-control" defaultValue={get(authUser, "db.email")} ref={props.emailRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="inputPhone">Phone Number</label>
              <input type="text" className="form-control" id="inputPhone" defaultValue={get(authUser, "db.phone")} ref={props.phoneRef}></input>
            </div>
            <div className="form-group">
              <label htmlFor="inputAddress">Address</label>
              <input type="text" className="form-control" id="inputAddress" placeholder="1234 Main St" defaultValue={get(authUser, "db.streetAddress1")} ref={props.streetAddress1Ref}></input>
            </div>
            <div className="form-group">
              <label htmlFor="inputAddress2">Address 2</label>
              <input type="text" className="form-control" id="inputAddress2"
                placeholder="Apartment, studio, or floor" defaultValue={get(authUser, "db.streetAddress2")} ref={props.streetAddress2Ref}></input>
            </div>
            <div className="form-row">
              <div className="form-group col-md-6">
                <label htmlFor="inputCity">City</label>
                <input type="text" className="form-control" id="inputCity" defaultValue={get(authUser, "db.city")} ref={props.cityRef}></input>
              </div>
              <div className="form-group col-md-4">
                <label htmlFor="inputState">State</label>
                <select id="inputState" className="form-control" defaultValue={get(authUser, "db.state")} ref={props.stateRef}>
              ...
              <div className="form-group col-md-2">
                ...
                <input type="text" className="form-control" id="inputZip" defaultValue={get(authUser, "db.zip")} ref={props.zipRef}></input>
              </div>
            </div>
          </div>
        )}
